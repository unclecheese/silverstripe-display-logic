...
class ConditionalsTest extends SapphireTest
{
	...
	public function testIsEqual()
	{
		...
		$this->assertStringContainsString('data-display-logic-masters="Field1"', $output);
	}
	...
	public function testAggregatedRules()
	{
		...
		$this->assertStringContainsString('data-display-logic-masters="Field1,Field2"', $output);
	}
