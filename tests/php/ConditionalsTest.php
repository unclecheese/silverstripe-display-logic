...
class ConditionalsTest extends SapphireTest
{
	...
	public function testIsEqual()
	{
		...
		$this->assertStringContainsString('data-display-logic-dispatchers="Field1"', $output);
	}
	...
	public function testIsGreaterThan()
	{
		...
		$output = $form->forTemplate();
		$this->assertStringContainsString('data-display-logic-eval="(this.findHolder(&#039;Field1&#039;).evaluateGreaterThan(&#039;100&#039;))"', $output);
		$this->assertStringContainsString('data-display-logic-eval="(this.findHolder(&#039;Field1&#039;).evaluateGreaterThan(&#039;200&#039;))"', $output);
		$this->assertStringContainsString('data-display-logic-dispatchers="Field1"', $output);
	...
	public function testIsLessThan()
	{
		...
		$output = $form->forTemplate();
		$this->assertStringContainsString('data-display-logic-eval="(this.findHolder(&#039;Field1&#039;).evaluateLessThan(&#039;50&#039;))', $output);
		$this->assertStringContainsString('data-display-logic-dispatchers="Field1"', $output);
	}
	...
	public function testAggregatedRules()
	{
		...
		$output = $form->forTemplate();
		$this->assertStringContainsString('(this.findHolder(&#039;Field1&#039;).evaluateLessThan(&#039;50&#039;) '
			. '&amp;&amp; this.findHolder(&#039;Field2&#039;).evaluateGreaterThan(&#039;80&#039;))', $output);
		$this->assertStringContainsString('data-display-logic-dispatchers="Field1,Field2"', $output);
	}
